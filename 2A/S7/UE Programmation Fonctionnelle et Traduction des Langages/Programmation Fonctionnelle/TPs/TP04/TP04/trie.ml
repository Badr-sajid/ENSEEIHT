...
(******************************************************************************)
let appartient mot (Trie(arbre,fd,fr)) = appartient_arbre (fd mot) arbre
...
(*   résultat   : aucun                                                       *)
(******************************************************************************)
let affiche p (Trie(arbre,fd,fr)) = let list = (List.map fr (parcours arbre)) in
  let rec afficher l = 
  match l with
  | [] -> ()
  | t::q -> p t; afficher q
...
(*let retrait_normalise mot (Trie(arbre,fd,fr)) = Trie(Normalisation(retrait_arbre (fd mot) arbre),fd,fr)*)
