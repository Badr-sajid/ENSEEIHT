...
package body LR.Synchro.Basique2 is
   ...
   begin
      return "Automate approche 2, lecteurs concurrents, sans politique d'accès";
   end Nom_Strategie;
   ...
   begin
      loop
        ...
        or  
            when ((not EcritureEnCours) and (Nbl = 0) and (Demander_Ecriture'count = 0)) => 
                accept Demander_Lecture; Nbl := 1;
        or 
            when ((not EcritureEnCours) and (Nbl >= 1) and (Demander_Ecriture'count = 0)) => 
