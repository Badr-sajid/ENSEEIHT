...
begin
    ...
    P2 := P1;                  -- XXX Conseillé ?   	non elle n'est pas conseillé
    pragma Assert (P1 = P2);

    Depiler (P2);              -- XXX Quel effet ?	Supprimer B de la pile.
    Afficher (P2); New_Line;   -- XXX Qu'est ce qui s'affiche ?   [A >
    Afficher (P1); New_Line;   -- XXX Qu'est ce qui s'affiche ?   [A , >
    -- XXX Que donne l'exécution avec valkyrie ?	L'execution avec valkyrie donne des erreur à propos de l'affectation.
