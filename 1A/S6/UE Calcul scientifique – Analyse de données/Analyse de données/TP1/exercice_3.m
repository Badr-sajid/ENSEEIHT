...
% Calcul  des vecteurs propres
    ...
    W(:,ordre);
    C = X_centre*W;
    I1 = reshape(C(:,1),size(R));
    I2 = reshape(C(:,2),size(R));
    I3 = reshape(C(:,3),size(R));

A1 = (1/3)*X_centre*ones(3,1);
I1 = reshape(A1,size(R));
A2 = X_centre*[0.2989 ; 0.5870 ; 0.1140];
I2 = reshape(A2,size(R));
% Affichage du canal R
    figure
    subplot(2,1,1) 
    imagesc(I1)
