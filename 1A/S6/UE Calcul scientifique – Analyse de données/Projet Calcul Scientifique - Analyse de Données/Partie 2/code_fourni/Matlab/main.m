...
flag3;
for i = 1:n_ev3
    qv3(i) = norm(AAt*V3(:,i) - W3(i)*V3(:,i))/norm(W3(i));
end
...
rng(s);
t_v0 =  cputime;
[W0, V0, it1, flag0] = subspace_iter_v0(AtA, m, eps, maxit);
t_v0 = cputime-t_v0;
q0 = norm(W0 - WA(1:m))/norm(WA);
flag0;

for i = 1:m
    qv0(i) = norm(AtA*V0(:,i) - W0(i)*V0(:,i))/norm(W0(i));
end
...
t_v1 =  cputime;
[ W1, V1, n_ev1, k1, flag1 ] = subspace_iter_v1( AtA, m, percentage, eps, maxit );
t_v1 = cputime-t_v1;
...
flag3;
for i = 1:n_ev3
    qv3(i) = norm(AtA*V3(:,i) - W3(i)*V3(:,i))/norm(W3(i));
end
fprintf('iter3 : Temps v3 = %0.3e\n', t_v3);
fprintf('iter3 : Qualité de la solution valeurs propres / eig = %0.3e\n',q3);
fprintf('iter3 : Qualité de la solution couple propres = [%0.3e - %0.3e]\n', min(qv3), max(qv3));
