...
procedure Exemples_Memoire_Dynamique is
    ...
    begin
        ...
        -- Après l'execution on ne trouve aucun erreur.
        --
    ...
    -- Cette procedure affichera : valeur de Ptr.all ?  123
    ...
    begin
        ...
        -- On a besoin de la détruire car P est détruite automatiquement dès la fin du sous-programme mais les cases sur lesquelles elle pointe ne sons pas détruite.
