...
if theta_1 < theta_2
    cond = find(theta_1<=theta_donnees_bruitees & theta_donnees_bruitees<=theta_2);
end
if theta_1 >= theta_2
        cond = find((0<=theta_donnees_bruitees & theta_donnees_bruitees<= theta_2) | (theta_1<=theta_donnees_bruitees & theta_donnees_bruitees<=2*pi));
end
x_donnees_bruitees = x_donnees_bruitees(cond);
y_donnees_bruitees = y_donnees_bruitees(cond);
